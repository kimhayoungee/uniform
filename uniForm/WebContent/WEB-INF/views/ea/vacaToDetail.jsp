         ...
         $(document).ready(function(){
             ...
             $("#ap_btn").click(function(){
 				...
 				if(r==true){
 					...
 					if(state=="1차검토") $("#ea_stateno").val("76");
 					
 	            	$("#eaForm").attr("action", "/ea/approval.uni");
 	            	$("#eaForm").submit();
 				}
             }); 
            ...
            <td align="right">
               ...
               <table class="ea">
                  <tr height="35">
                     ...
                     <td width="120" align="center">검토</td>
                     <td width="120" align="center">승인</td>
                  </tr>
                  <tr height="105">
      ...
      <table class="comment">
		 <tr height="35">
   		 ...
   		 <tr height="35">
   		 	<td></td>
   		 	<td></td>
   		 	<td><input type="button" name="cm_btn" id="cm_btn" value="결재의견 입력">   	  
