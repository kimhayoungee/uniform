...
<%
		if(icurPage>1){
%>
			<span class="btnFirst"><a href="javascript:goBoardList('1')">◀</a></span>
<%			
		}else{
%>
...
<%			
		...
		if(prevLast>0){
%>		
			<span class="btnPrev"><a href="javascript:goBoardList(<%=prevLast%>)">◁</a></span>
<%
		}else{
%>			
...
%>
				<li><a href="javascript:goBoardList(<%=i%>)"><%=i %></a></li>
<%				
			}
		}
%>		
...
%>
			<span class="btnNext"><a href="javascript:goBoardList(<%=nextFirst %>)">▷</a></span>
<%			
		}else{
%>
...
%>
			<span class="btnEnd"><a href="javascript:goBoardList(<%=lastPage%>)">▶</a></span>
<%			
		}else{
%>
