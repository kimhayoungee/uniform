...
<%
		if(icurPage>1){
%>
			<span class="btnFirst"><a href="javascript:goBoardScrapList('1')">◀</a></span>
<%			
		}else{
%>
...
<%			
		...
		if(prevLast>0){
%>		
			<span class="btnPrev"><a href="javascript:goBoardScrapList(<%=prevLast%>)">◁</a></span>
<%
		}else{
%>			
...
%>
				<li><a href="javascript:goBoardScrapList(<%=i%>)"><%=i %></a></li>
<%				
			}
		}
%>		
...
%>	
			<span class="btnNext"><a href="javascript:goBoardScrapList(<%=nextFirst%>)">▷</a></span>
<%			
		}else{
%>
...
%>
			<span class="btnEnd"><a href="javascript:goBoardScrapList(<%=lastPage%>)">▶</a></span>
<%			
		}else{
%>
