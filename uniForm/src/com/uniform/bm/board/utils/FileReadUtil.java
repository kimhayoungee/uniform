package com.uniform.bm.board.utils;
...
public class FileReadUtil {
	...
	public static void readFile(HttpServletRequest request
		...
		logger.info("bm_file : " + bm_file + ", path >>> : " + path);
		
		String realFilePath = path  + "/" + bm_file;
		...
		response.setHeader("Content-Disposition","attachment; filename=" + bm_file + ";");
