      ...
      <table border="0" style="border-collapse:collapse;">    
         <tr>
         	<td colspan="2" width="770">         	            
               <input type="button" class="blue_btn" name="poomInsert_btn" id="poomInsert_btn" value="완료">
               <input type="button" class="grey_btn" name="lineInsert_btn" id="lineInsert_btn" value="결재라인지정">
            </td>
         </tr>
         <tr height="70" >
            <td colspan="2" style="text-align:center; font-size:30px;">품 의 서 </td>
         </tr>
         <tr>
            <td width="350">
            <!-- 공통부분(파일업로드,폼) -->      
               ...
               <table class="eadocument" align="left">
                  ...
                  <tr height="35">
                     ...
                     <td><input type="text" name="ea_linename" id="ea_linename" value="품의전결" style="width:200px;"></td>
                  </tr>
                  <tr height="35">
                     <td class=cate>팀   :</td>
            ...
            <tr>
	 		...
	 		<tr>
	 			<td align="center"><input type="hidden" name="ea_line3" id="ea_line3" readonly></td></tr> 
      ...
      <table class="eapoom">
         ...
         <tr height=500>
            ...
            <td width="800" height="500" colspan="2">
               <textarea style="height:500px; width:880px;" name="po_data" id="po_data"></textarea>
            </td>
         </tr>
      </table>   
      </form>
