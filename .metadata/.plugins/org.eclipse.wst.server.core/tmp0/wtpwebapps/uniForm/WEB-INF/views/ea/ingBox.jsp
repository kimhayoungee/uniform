...
<%
		...
		//결재중 리스트
		Object obj1 = request.getAttribute("inglist");
		List<PageVO> inglist = (List<PageVO>)obj1;
		String do_docno = "";
		String do_type = "";
		String do_writer = "";
		String do_title = "";
		...
		<script>
			$(document).ready(function(){
				...
				$("#s_btn2").click(function(){		
					...
					$("#sForm").attr("action", "/ea/goMenuIng.uni");
					$("#sForm").submit();
				});
...
<div id="box_sidebar">
	...
	<nav>
		<ul>		
			...
			<li class="on"><a href="/ea/goMenuIng.uni">결재중 문서</a></li>
...
<div id="box_conts">	
	<article id="skipnav">
		...
		<table class="결재중 문서" width="500" border="0">
			<tr>
			<td>
...
<!-- 					<input type="button" name="s" id="s" value="검색"> -->
				</td>
			</tr>
			</table>
			</form>
