...
%>
		...
		<script>
			$(document).ready(function(){
				...
				if(t!=null&&t!="") $("#type").val(t).attr("selected", true);
				...
				$("#s_btn2").click(function(){		
					...
					$("#sForm").attr("action", "/ea/goMenuFin.uni");
					$("#sForm").submit();
				});
...
<div id="box_sidebar">
	...
	<nav>
		<ul>		
			...
			<li class="on"><a href="/ea/goMenuFin.uni">완료함</a></li>
