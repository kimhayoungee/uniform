		...
		<form id="eaDetailForm" name="eaDetailForm" enctype="multipart/form-data" method="post">
			...
			<table align="right">
				...
				<tr>
					...
					<td><input type="text" style=border:0 name="up_category" id="up_category" value="<%=up_category %>" readonly>
						<select id="selectBox" name="selectBox" onChange="setValues();">
								...
								<option value="기안서" selected disabled hidden>기안서</option>
								<option value="품의서" selected disabled hidden>품의서</option>
								<option value="휴가계" selected disabled hidden>휴가계</option>
								<option value="기타" selected disabled hidden>기타</option>
				...
				<tr>
					...
					<input type="button" class="blue_btn" align="left" style="float:left;" name="download_btn" id="download_btn" value="파일다운로드"></td>
				</tr>			
			</table>
			</div>
		</form>
