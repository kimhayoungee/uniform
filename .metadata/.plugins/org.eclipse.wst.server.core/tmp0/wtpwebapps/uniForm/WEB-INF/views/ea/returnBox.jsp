...
<%
		...
		//반려함 리스트
		Object obj = request.getAttribute("reList");
		List<PageVO> reList = (List<PageVO>)obj;
		String do_docno = "";
		String do_type = "";
		String do_writer = "";
		String do_title = "";
		...
		<script>
			$(document).ready(function(){
				...
				$("#s_btn2").click(function(){		
					...
					$("#sForm").attr("action", "/ea/goMenuRe.uni");
					$("#sForm").submit();
				});
...
<div id="box_sidebar">
	...
	<nav>
		<ul>		
			...
			<li class="on"><a href="/ea/goMenuRe.uni">반려함</a></li>
...
<!-- 				<input type="button" name="s" id="s" value="검색"> -->
			...
			<table summary="글목록">
				...
				<tr>			
					...
					<th scope="col" width="80">최종결재자</th>
