...
<%
		...
		//결재할 리스트
		Object obj = request.getAttribute("toList");
		List<PageVO> toList = (List<PageVO>)obj;
		String do_docno = "";
		String do_type = "";
		String do_writer = "";
		String do_title = "";
		...
		<script>
			$(document).ready(function(){
				...
				$("#s_btn1").click(function(){		
					...
					$("#sForm").attr("action", "/ea/goMenuTo.uni");
					$("#sForm").submit();
				});
		...
		<ul>		
			<li><a class="more">결재문서 작성</a>			
				<ul class="moreli" style="display:none">
					<li><a href="/ea/goGianPop.uni" onclick="window.open(this.href,'','width=500, height=350'); return false;">기안서 작성</a></li>
					<li><a href="#">품의서 작성</a></li>
					<li><a href="/ea/goVacaWrite.uni">휴가계 작성</a></li>
				</ul>
			</li>
	...
	<article id="skipnav">
		...
		<table class="결재할 문서" width="500">
			...
			<tr>
				...
				<td>
					<input type="text" name="do_writer" id="do_writer" style="width:70px;">
			...
			<tr>
				...
				<td>
					<select name="state" id="state">
						...
						<option value="71">대기</option>
						<option value="72">1차 검토</option>
						<option value="73">2차 검토</option>
					</select>					
				</td>
...
%>				
			<tbody>	
				<tr data-num="<%=do_docno%>" data-type="<%=do_type %>">
					...
					<td class="alignL"><span class="goToDetail"><%=do_title %></span></td>
...
%>
			<tbody>
			<tr>
				<td class="alignC first last" colspan="6" height="125">조회된 문서가 없습니다.</td>
			</tr>
			</tbody>
<%					
			}
