 ...
 * Generated at: 2021-03-30 16:13:17 UTC
...
return;
	...
	if(sessionBool){
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t$(\"#goWriteForm\").attr(\"action\", \"/ea/gian/pop.uni\");\r\n");
      ...
      out.write("\t\t\t\t\t\t$(\"#goDetailForm\").attr(\"action\", \"/ea/gian.uni\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\tvar doctype = $(this).parents(\"tr\").attr(\"data-type\");\r\n");
      out.write("\t\t\t\t\tif(doctype.match(\"기안\")){\r\n");
      out.write("\t\t\t\t\t\t$(\"#goDetailForm\").attr(\"action\", \"/ea/gian/detail.uni\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\tif(doctype.match(\"휴가\")){\r\n");
      ...
      out.write("\t\t\t\t\t$(\"#goBox\").submit();\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t//결재중문서 메뉴 이동\r\n");
      out.write("\t\t\t\t$(\".ingBox\").click(function(){\r\n");
      out.write("\t\t\t\t\t$(\"#goBox\").attr(\"action\", \"/ea/ingbox.uni\");\r\n");
      out.write("\t\t\t\t\t$(\"#goBox\").submit();\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t//반려함 메뉴 이동\r\n");
      out.write("\t\t\t\t$(\".returnBox\").click(function(){\r\n");
      out.write("\t\t\t\t\t$(\"#goBox\").attr(\"action\", \"/ea/returnbox.uni\");\r\n");
      out.write("\t\t\t\t\t$(\"#goBox\").submit();\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t//완료함 메뉴 이동\r\n");
      out.write("\t\t\t\t$(\".finBox\").click(function(){\r\n");
      out.write("\t\t\t\t\t$(\"#goBox\").attr(\"action\", \"/ea/finbox.uni\");\r\n");
      out.write("\t\t\t\t\t$(\"#goBox\").submit();\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t$(\"#ed_btn\").click(function(){\r\n");
      out.write("\t\t\t\t\t$(\"#goBox\").attr(\"action\", \"/ea/didbox.uni\");\r\n");
      out.write("\t\t\t\t\t$(\"#goBox\").submit();\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t//메뉴\r\n");
      ...
      out.write("\t\t\t\t$(\"#linenameForm\").attr(\"action\", \"/ea/gian/write.uni\");\r\n");
      out.write("\t\t\t\t$(\"#linenameForm\").submit();\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t<tr class=\"menu_title\">\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"4\" align=\"left\"><span class=\"returnBox\">반려함</span></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t<tr class=\"menu_title\">\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"4\" align=\"left\"><span class=\"ingBox\">결재중 문서</span></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"contents\">\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"con_type\">분류</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"con_title\">제목</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tr class=\"menu_title\">\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"4\" align=\"left\"><span class=\"finBox\">완료함</span></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\t\t\t\t\t\t\r\n");
